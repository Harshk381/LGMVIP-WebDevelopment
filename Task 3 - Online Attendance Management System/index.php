    ...
    <table class="table table-bordered table-striped">
     ...
     <!-- FOOTER -->
      <footer style="background; height:140%;">
        ...
        <p>&copy; &middot;  developed by <a href="https://localhost/online attendance management system/index.php">Harsh Khandelwal </a><a href="http://localhost//index.php"> &middot; Privacy</a> &middot; <a href="http://index.php">Terms</a></p>
      </footer>
